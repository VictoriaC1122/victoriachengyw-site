    ...
    createPhotoEvent({
      ...
      activityBlocks: [
        ...
        },
        {
          ...
          imageSrc: "assets/photos/annual-2025-11-textile-03.jpg",
          imageAlt: localized("紡織例會手作體驗現場", "Hands-on workshop at the textile meeting"),
          imageCaption: localized("紡織例會手作體驗。", "Hands-on workshop at the textile meeting."),
        },
      ],
      gallery: [
        galleryImage(
    ...
    createPhotoEvent({
      ...
      gallery: [
        ...
        galleryImage(
          ...
          "區塊鏈職業例會活動合照",
          "Group photo from the blockchain career meeting",
          "區塊鏈職業例會活動合照。",
          "Group photo from the blockchain career meeting.",
        ),
        galleryImage(
          ...
          "區塊鏈職業例會講座現場",
          "Talk at the blockchain career meeting",
          "區塊鏈職業例會現場分享。",
          "Talk at the blockchain career meeting.",
        ),
      ],
